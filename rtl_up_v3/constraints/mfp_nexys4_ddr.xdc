...
set_property -dict { PACKAGE_PIN E17   IOSTANDARD LVCMOS33 } [get_ports { PADDLE_A_BTN }]; #IO_L16P_T2_A28_15 Sch=ja[8]
set_property -dict { PACKAGE_PIN F18   IOSTANDARD LVCMOS33 } [get_ports { PADDLE_B_BTN }]; #IO_L22N_T3_A16_15 Sch=ja[9]
